                ...
                >
                  ...
                  >
                    ...
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all ${
                      isActive ? 'bg-emerald-500 text-white shadow-sm shadow-emerald-500/30' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200 group-hover:text-gray-700'
                    }`}>
                      <item.icon className="w-[18px] h-[18px]" />
                    </div>
                    <span className="flex-1">{item.label}</span>
                    {item.badge && (
                      <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${isActive ? 'bg-emerald-100 text-emerald-700' : 'bg-rose-100 text-rose-600'}`}>
                        {item.badge}
                      </span>
                    )}
                  </Link>
            ...
            {sidebarItems.slice(5).map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {isActive && (
                      <motion.div layoutId="activeIndicator" className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 rounded-r-full bg-emerald-500" />
                    )}
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all ${
                      isActive ? 'bg-emerald-500 text-white shadow-sm shadow-emerald-500/30' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200 group-hover:text-gray-700'
                    }`}>
